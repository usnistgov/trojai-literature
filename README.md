...
28. [Composite Backdoor Attack for Deep Neural Network by Mixing Existing Benign Features](https://dl.acm.org/doi/10.1145/3372297.3423362)
29. [SPA: Stealthy Poisoning Attack](https://dl.acm.org/doi/abs/10.1145/3444370.3444589)
30. [Backdoor Attack with Sample-Specific Triggers](https://arxiv.org/abs/2012.03816)
31. [Explainability Matters: Backdoor Attacks on Medical Imaging](http://arxiv.org/abs/2101.00008)
32. [Escaping Backdoor Attack Detection of Deep Learning](https://link.springer.com/chapter/10.1007/978-3-030-58201-2_29)
33. [Just How Toxic is Data Poisoning? A Unified Benchmark for Backdoor and Data Poisoning Attacks](https://arxiv.org/abs/2006.12557)
34. [Poisoning Attacks on Cyber Attack Detectors for Industrial Control Systems](https://arxiv.org/pdf/2012.15740.pdf)
35. [Fair Detection of Poisoning Attacks in Federated Learning](https://ieeexplore.ieee.org/abstract/9288279)
36. [Deep Feature Space Trojan Attack of Neural Networks by Controlled Detoxification*](https://arxiv.org/pdf/2012.11212.pdf)
37. [Stealthy Poisoning Attack on Certified Robustness](http://www.cs.tulane.edu/~jhamm3/papers/neuripsw20am.pdf)
38. [Machine Learning with Electronic Health Records is vulnerable to Backdoor Trigger Attacks](http://www.cs.tulane.edu/~jhamm3/papers/aaaiw21bj.pdf) 
39. [Data Security for Machine Learning: Data Poisoning, Backdoor Attacks, and Defenses](https://arxiv.org/pdf/2012.10544.pdf)
40. [Detection of Backdoors in Trained Classifiers Without Access to the Training Set](https://pubmed.ncbi.nlm.nih.gov/33326384/)
41. [TROJANZOO: Everything you ever wanted to know about neural backdoors(but were afraid to ask)](https://arxiv.org/pdf/2012.09302.pdf)
...
43. [DeepSweep: An Evaluation Framework for Mitigating DNN Backdoor Attacks using Data Augmentation](https://arxiv.org/abs/2012.07006)
44. [Poison Attacks against Text Datasets with Conditional Adversarially Regularized Autoencoder](https://arxiv.org/abs/2010.02684)
45. [Strong Data Augmentation Sanitizes Poisoning and Backdoor Attacks Without an Accuracy Tradeoff](https://arxiv.org/abs/2011.09527)
46. [BaFFLe: Backdoor detection via Feedback-based Federated Learning](https://arxiv.org/abs/2011.02167)
47. [Detecting Backdoors in Neural Networks Using Novel Feature-Based Anomaly Detection](https://arxiv.org/abs/2011.02526)
48. [Mitigating Backdoor Attacks in Federated Learning](https://arxiv.org/abs/2011.01767)
49. [FaceHack: Triggering backdoored facial recognition systems using facial characteristics](https://arxiv.org/abs/2006.11623)
50. [Customizing Triggers with Concealed Data Poisoning](https://arxiv.org/abs/2010.12563)
51. [Backdoor Learning: A Survey](https://arxiv.org/abs/2007.08745)
52. [Rethinking the Trigger of Backdoor Attack](https://arxiv.org/abs/2004.04692)
53. [AEGIS: Exposing Backdoors in Robust Machine Learning Models](https://arxiv.org/abs/2003.00865)
54. [Weight Poisoning Attacks on Pre-trained Models](https://arxiv.org/abs/2004.06660)
55. [Poisoned classifiers are not only backdoored, they are fundamentally broken](https://arxiv.org/abs/2010.09080)
56. [Input-Aware Dynamic Backdoor Attack](https://arxiv.org/abs/2010.08138)
57. [Reverse Engineering Imperceptible Backdoor Attacks on Deep Neural Networks for Detection and Training Set Cleansing](https://arxiv.org/abs/2010.07489)
58. [BAAAN: Backdoor Attacks Against Autoencoder and GAN-Based Machine Learning Models](https://arxiv.org/abs/2010.03007)
59. [Don’t Trigger Me! A Triggerless Backdoor Attack Against Deep Neural Networks](https://arxiv.org/abs/2010.03282)
60. [Toward Robustness and Privacy in Federated Learning: Experimenting with Local and Central Differential Privacy](https://arxiv.org/abs/2009.03561)
61. [CLEANN: Accelerated Trojan Shield for Embedded Neural Networks](https://arxiv.org/abs/2009.02326)
62. [Witches’ Brew: Industrial Scale Data Poisoning via Gradient Matching](https://arxiv.org/abs/2009.02276)
63. [Intrinsic Certified Robustness of Bagging against Data Poisoning Attacks](https://arxiv.org/abs/2008.04495)
64. [Can Adversarial Weight Perturbations Inject Neural Backdoors?](https://arxiv.org/abs/2008.01761)
65. [Trojaning Language Models for Fun and Profit](https://arxiv.org/abs/2008.00312)
66. [Practical Detection of Trojan Neural Networks: Data-Limited and Data-Free Cases](https://arxiv.org/abs/2007.15802)
67. [Class-Oriented Poisoning Attack](https://arxiv.org/abs/2008.00047)
68. [Noise-response Analysis for Rapid Detection of Backdoors in Deep Neural Networks](https://arxiv.org/abs/2008.00123)
69. [Cassandra: Detecting Trojaned Networks from Adversarial Perturbations](http://arxiv.org/abs/2007.14433)
70. [Backdoor Learning: A Survey](http://arxiv.org/abs/2007.08745)
71. [Backdoor Attacks and Countermeasures on Deep Learning: A Comprehensive Review](http://arxiv.org/abs/2007.10760)
72. [Live Trojan Attacks on Deep Neural Networks](http://arxiv.org/abs/2004.11370)
73. [Odyssey: Creation, Analysis and Detection of Trojan Models](https://arxiv.org/abs/2007.08142)
74. [Data Poisoning Attacks Against Federated Learning Systems](http://arxiv.org/abs/2007.08432)
75. [Blind Backdoors in Deep Learning Models](http://arxiv.org/abs/2005.03823)
76. [Deep Learning Backdoors](http://arxiv.org/abs/2007.08273)
77. [Attack of the Tails: Yes, You Really Can Backdoor Federated Learning](https://arxiv.org/abs/2007.05084)
78. [Backdoor Attacks on Facial Recognition in the Physical World](http://arxiv.org/abs/2006.14580)
79. [Graph Backdoor](http://arxiv.org/abs/2006.11890)
80. [Backdoor Attacks to Graph Neural Networks](http://arxiv.org/abs/2006.11165)
81. [You Autocomplete Me: Poisoning Vulnerabilities in Neural Code Completion](http://arxiv.org/abs/2007.02220)
82. [Reflection Backdoor: A Natural Backdoor Attack on Deep Neural Networks](http://arxiv.org/abs/2007.02343)
83. [Trembling triggers: exploring the sensitivity of backdoors in DNN-based face recognition](https://doi.org/10.1186/s13635-020-00104-z)
84. [Just How Toxic is Data Poisoning? A Unified Benchmark for Backdoor and Data Poisoning Attacks](https://arxiv.org/abs/2006.12557)
85. [Adversarial Machine Learning -- Industry Perspectives](https://arxiv.org/abs/2002.05646)
86. [ConFoc: Content-Focus Protection Against Trojan Attacks on Neural Networks](https://arxiv.org/abs/2007.00711)
87. [Model-Targeted Poisoning Attacks: Provable Convergence and Certified Bounds](https://arxiv.org/abs/2006.16469)
88. [Deep Partition Aggregation: Provable Defense against General Poisoning Attacks](https://arxiv.org/abs/2006.14768)
89. [The TrojAI Software Framework: An OpenSource tool for Embedding Trojans into Deep Learning Models*](https://arxiv.org/abs/2003.07233)
90. [BadNL: Backdoor Attacks Against NLP Models](https://arxiv.org/abs/2006.01043)
    <details>
      <summary>
      Summary
      </summary>  
